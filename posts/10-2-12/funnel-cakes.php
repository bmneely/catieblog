      ...
      <div class="content">
        <div class="post-container">
          <div class="post-title">
            <h2>funnel cakes and knitting</h2>
            <h3>Tuesday, October 2, 2012</h3>
          </div>
          <div class="post-body">
            <p>Have you seen the <a href="http://www.ravelry.com/patterns/library/high-plains-drifter">High Plains Drifter</a> pattern on Ravelry?  I love the simplicity of it.  It's perfect and pretty, but not too fussy and fiddly.</p>
            <img class="post-photos-smallest" src="photos/funnelcake01.jpg">
            ...
            <p>They must be:
              <ol>
                <li>Easy to carry around in a backpack FULL of everything else.</li>
            ...
            <p>This project has all of those qualities!  So, I started one.</p>
            <img class="post-photos-smallest" src="photos/funnelcake02.jpg">
            ...
            <img class="post-photos-smallest" src="photos/funnelcake03.jpg">
            <p>I don't really have any pictures that showcase it's greatness yet.  Maybe soon.</p>
            <p>And here's the grain free funnel cake I made this afternoon.</p>
            <img class="post-photos-smallest" src="photos/funnelcake04.jpg">
